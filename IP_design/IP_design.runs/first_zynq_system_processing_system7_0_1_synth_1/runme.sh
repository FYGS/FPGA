...
HD_PWD='/home/soualo/Documents/FPGA/IP_design/IP_design.runs/first_zynq_system_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_system_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_system_processing_system7_0_1.tcl
